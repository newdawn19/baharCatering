...
import com.bahar.common.dto.merchant.StoreDto;
import com.bahar.common.dto.merchant.StoreInfo;
...
public interface StoreService extends IService<MtStore> {
     ...
     * @return
     */
    MtStore saveStore(StoreDto storeDto, AccountInfo accountInfo) throws BusinessCheckException;
     ...
     * @return
     * */
    List<MtStore> getActiveStoreList(Integer merchantId, Integer storeId, String name);
