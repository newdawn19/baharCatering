...
import com.bahar.common.dto.commission.CommissionRuleItemDto;
...
import com.bahar.common.param.CommissionRuleItemParam;
...
import com.bahar.common.service.GoodsService;
...
import com.bahar.repository.mapper.MtCommissionRuleItemMapper;
import com.bahar.repository.mapper.MtCommissionRuleMapper;
...
public class CommissionRuleServiceImpl extends ServiceImpl<MtCommissionRuleMapper, MtCommissionRule> implements CommissionRuleService {
    ...
    public MtCommissionRule updateCommissionRule(CommissionRuleParam commissionRule, AccountInfo accountInfo) throws BusinessCheckException {
        ...
        if (accountInfo.getMerchantId() > 0 && !accountInfo.getMerchantId().equals(mtCommissionRule.getMerchantId())) {
