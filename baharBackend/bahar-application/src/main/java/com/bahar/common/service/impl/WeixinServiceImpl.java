...
import com.bahar.common.bean.H5SceneInfo;
import com.bahar.common.bean.WxPayBean;
import com.bahar.common.bean.shoppingOrders.*;
import com.bahar.common.dto.member.WxCardDto;
import com.bahar.common.dto.order.OrderDto;
import com.bahar.common.dto.order.UserOrderDto;
import com.bahar.common.enums.*;
import com.bahar.common.http.HttpRESTDataClient;
import com.bahar.common.service.*;
import com.bahar.common.util.AliyunOssUtil;
import com.bahar.common.util.Base64Util;
import com.bahar.common.util.RedisUtil;
import com.bahar.common.vo.printer.OrderStatusType;
import com.bahar.framework.exception.BusinessCheckException;
import com.bahar.framework.web.ResponseObject;
import com.bahar.repository.mapper.MtGoodsMapper;
import com.bahar.repository.mapper.MtOrderGoodsMapper;
import com.bahar.repository.mapper.MtUploadShippingLogMapper;
import com.bahar.repository.model.*;
import com.bahar.utils.QRCodeUtil;
...
public class WeixinServiceImpl implements WeixinService {
    ...
    private static final String BAHAR_ACCESS_TOKEN_PRE = "BAHAR_ACCESS_TOKEN";
    ...
    public String getAccessToken(Integer merchantId, boolean isMinApp, boolean useCache) {
        ...
        String tokenKey = BAHAR_ACCESS_TOKEN_PRE + platForm;
        ...
        try {
            ...
            if (data.get("errcode").toString().equals("0")) {
                ...
                try {
                    ...
                    com.bahar.common.util.QRCodeUtil.createQrCode(out, content, 800, 800, "png", "");
                    // 对数据进行Base64编码
    ...
    private String getJsApiTicket(Integer merchantId) {
        String ticketKey = "BAHAR_JSAPI_TICKET_MP";
        if (merchantId != null && merchantId > 0) {
