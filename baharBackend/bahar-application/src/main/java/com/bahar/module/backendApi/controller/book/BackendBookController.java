package com.bahar.module.backendApi.controller.book;

import com.bahar.common.dto.book.BookDto;
import com.bahar.common.dto.book.BookTimeDto;
...
import com.bahar.common.service.BookCateService;
...
public class BackendBookController extends BaseController {
    ...
    public ResponseObject list(@ModelAttribute BookPage bookPage) throws BusinessCheckException {
        ...
        List<MtStore> storeList = storeService.getActiveStoreList(accountInfo.getMerchantId(), accountInfo.getStoreId(), StatusEnum.ENABLED.getKey());
