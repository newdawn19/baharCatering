...
import com.bahar.common.service.CommissionRelationService;
...
public class BackendCommissionRelationController extends BaseController {
    ...
    public ResponseObject updateStatus(@RequestBody StatusParam param) throws BusinessCheckException {
        ...
        MtCommissionRelation mtCommissionRelation = commissionRelationService.getById(param.getId());
        if (accountInfo.getMerchantId() != null && accountInfo.getMerchantId() > 0) {
        ...
        mtCommissionRelation.setStatus(param.getStatus());
        mtCommissionRelation.setOperator(accountInfo.getAccountName());
