...
import com.bahar.common.dto.common.DateDto;
import com.bahar.common.dto.common.ParamDto;
import com.bahar.common.dto.coupon.PreStoreRuleDto;
...
import com.bahar.common.enums.CouponUseForEnum;
import com.bahar.common.enums.StatusEnum;
import com.bahar.common.param.CouponPage;
import com.bahar.common.param.SendCouponParam;
...
import com.bahar.repository.mapper.MtCouponGoodsMapper;
import com.bahar.repository.mapper.MtCouponGroupMapper;
...
public class BackendCouponController extends BaseController {
    ...
    public ResponseObject saveCouponHandler(@RequestBody ReqCouponDto reqCouponDto) throws BusinessCheckException, ParseException {
        ...
        couponPage.setPageSize(Constants.PAGE_SIZE);
        ...
        couponService.saveCoupon(reqCouponDto, accountInfo);
        return getSuccessResult(true);
    }
    ...
    public ResponseObject sendCoupon(@RequestBody SendCouponParam param) throws BusinessCheckException {
        ...
        couponService.batchSendCoupon(Integer.parseInt(couponId), userIdList, Integer.parseInt(num), SeqUtil.getUUID(), accountInfo);
        return getSuccessResult(true);
    }
}
