package com.bahar.module.backendApi.controller.goods;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.bahar.common.dto.common.ParamDto;
import com.bahar.common.dto.goods.GoodsDto;
import com.bahar.common.dto.goods.GoodsSkuDto;
import com.bahar.common.dto.goods.GoodsSpecChildDto;
import com.bahar.common.dto.goods.GoodsSpecItemDto;
import com.bahar.common.dto.system.AccountInfo;
import com.bahar.common.enums.GoodsTypeEnum;
import com.bahar.common.enums.StatusEnum;
import com.bahar.common.enums.YesOrNoEnum;
import com.bahar.common.param.GoodsListParam;
import com.bahar.common.param.StatusParam;
import com.bahar.common.service.*;
import com.bahar.common.util.CommonUtil;
import com.bahar.common.util.ExcelUtil;
...
import com.bahar.repository.mapper.MtGoodsSpecMapper;
...
public class BackendGoodsController extends BaseController {
    ...
    public ResponseObject info(@PathVariable("id") Integer goodsId) throws BusinessCheckException {
        ...
        // 会员等级列表
        List<MtUserGrade> gradeList = userGradeService.getMerchantGradeList(accountInfo.getMerchantId());
    ...
    @CrossOrigin
    @PreAuthorize("@pms.hasPermission('goods:goods:index')")
    public ResponseObject getBarCodeList(@PathVariable("id") Integer goodsId) {
        return getSuccessResult(true);
    }
}
