...
import com.bahar.common.dto.member.*;
...
import com.bahar.common.enums.UserSettingEnum;
import com.bahar.common.enums.YesOrNoEnum;
import com.bahar.common.param.MemberPage;
import com.bahar.common.service.*;
import com.bahar.common.util.*;
...
import com.bahar.module.backendApi.request.MemberSubmitRequest;
...
import static com.bahar.common.util.XlsUtil.objectConvertToString;
...
public class BackendMemberController extends BaseController {
    ...
    public ResponseObject list(@ModelAttribute MemberPage memberPage) throws BusinessCheckException {
        ...
        // 店铺列表
        List<MtStore> storeList = storeService.getActiveStoreList(accountInfo.getMerchantId(), 0, null);
    ...
    public void export(HttpServletRequest request, HttpServletResponse response, @ModelAttribute MemberPage memberPage) {
        ...
        // 会员等级映射
        List<MtUserGrade> userGradeList = userGradeService.getMerchantGradeList(accountInfo.getMerchantId());
