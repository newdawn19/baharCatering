...
import com.bahar.common.dto.order.ExpressDto;
...
import com.bahar.common.param.OrderListParam;
...
import com.bahar.utils.TimeUtils;
...
public class BackendOrderController extends BaseController {
    ...
    public ResponseObject delivered(@RequestBody Map<String, Object> param) throws BusinessCheckException {
        ...
        if (orderInfo != null && userInfo != null && orderInfo.getAddress() != null) {
            ...
            weixinService.sendSubscribeMessage(userInfo.getMerchantId(), userInfo.getId(), userInfo.getOpenId(), WxMessageEnum.DELIVER_GOODS.getKey(), "pages/order/index", params, new Date());
        }
